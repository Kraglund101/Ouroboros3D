...
class MVModel(nn.Module):
    ...
    def forward(
        ...
        #print("sample shape before flattening:", sample.shape)
        ...
        #print("sample shape after pre-process:", sample.shape)
        ...
        for i, downsample_block in enumerate(self.unet.down_blocks):
            if self.add_plucker:
                ...
                sample += plucker
                #print("sample shape after plucker embedding:", sample.shape," index", i)
            if (
